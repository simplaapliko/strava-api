...
private class StravaResponseInterceptor : Interceptor {
...
private const val limitHeader = "X-RateLimit-Limit"
private const val usageHeader = "X-RateLimit-Usage"

private fun getLimits(headers: Headers): Limits {
    val limits = headers.get(limitHeader)
    val usages = headers.get(usageHeader)
